  ...
  <main class="max-w-6xl mx-auto px-6 py-12">
    ...
    <div class="text-center mb-14">
      <h1 class="text-5xl font-bold mb-4 tracking-tight" style="color: #F5F2EE; font-family: 'Space Grotesk', sans-serif; line-height: 1.1;">
        Your card, <span style="color: #6366F1;">designed by AI</span>
      </h1>
...
onblur={() => {}}
        ...
        <div class="pt-2">
          ...
          <button
            ...
            style="background: #161616; color: #C9A84C; border: 1px solid #3A2E1A; font-family: 'Space Grotesk', sans-serif;"
          >
            ↓ Download Card
          </button>
        </div>
      ...
      <div class="flex flex-col items-center justify-start pt-2">
        ...
        {#if loading}
          <div class="w-full aspect-[1.75] rounded-2xl flex flex-col items-center justify-center" style="background: #161616; border: 1px solid #2A2A2A;">
            <div class="w-6 h-6 rounded-full border-2 mb-3" style="border-color: #6366F1; border-top-color: transparent; animation: spin 1s linear infinite;"></div>
            <p class="text-sm" style="color: #6B6B6B;">Crafting your card...</p>
          </div>
        {/if}

        {#if cardData}
          <div class="relative" style="filter: drop-shadow(0 25px 50px rgba(99,102,241,0.15));">
            <div
              id="card-preview"
